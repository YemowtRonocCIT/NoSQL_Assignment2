...
REM #"--"--"--"--"--"--"--"--"--"--"--"--"--"--"--"--"--"--"--"--"--"--"--"---#
REM #						      #
REM # 0. Set desktop_name to the name of the computer       #
REM #						      #
REM #"--"--"--"--"--"--"--"--"--"--"--"--"--"--"--"--"--"--"--"--"--"--"--"---#
REM #	
...
REM #	
start /b %mongos_exe% --configdb %desktop_name%.local:26050,%desktop_name%.local:26051,%desktop_name%.local:26052
REM #	    
REM # 2.2. Remaining "C:"\"Program Files"\"MongoDB"\"Server"\"3.0"\"bin"\"mongos processes listen to the explicit ports assigned by us
REM #	
start /b %mongos_exe% --configdb %desktop_name%.local:26050,%desktop_name%.local:26051,%desktop_name%.local:26052 --port 26061
start /b %mongos_exe% --configdb %desktop_name%.local:26050,%desktop_name%.local:26051,%desktop_name%.local:26052 --port 26062
start /b %mongos_exe% --configdb %desktop_name%.local:26050,%desktop_name%.local:26051,%desktop_name%.local:26052 --port 26063
REM #	
REM #"--"--"--"--"--"--"--"--"--"--"--"--"--"--"--"--"--"--"--"--"--"--"--"---#
REM #						      #
